...
main_path=pretrain
audio_from=Audio
source_data_path="/home/panzexu/datasets/LRS3/audio/${audio_from}"
xvector_npy_path="/home/panzexu/datasets/LRS3/ivector/"

main_data_path=exp/${audio_from}/${main_path}/data
mfcc_path=exp/${audio_from}/${main_path}/MFCC
vad_path=exp/${audio_from}/${main_path}/VAD
vector_path=exp/${audio_from}/${main_path}/ivector
